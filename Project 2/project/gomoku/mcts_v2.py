...
class TreeNode():
    ...
    def select(self) -> 'TreeNode':
        """
        Select the best child node within the tree. You should design your tree policy here.
        """
        leaf_node = None
        ######### YOUR CODE HERE #########
    ...
    def simulate(self) -> int:
        """
        Run simulation from the current node until the game is over. You should design your rollout policy here.
        """
        result = 0
        ######### YOUR CODE HERE #########
    ...
    def ucb(self, c=math.sqrt(2)) -> float:
        """
        Original ucb formula. You may not need this for your implementation.
        """
